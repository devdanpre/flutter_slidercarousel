...
abstract class _CustomLayoutStateBase<T extends _SubSliderCarousel> extends State<T>
  ...
  void initState() {
    if (widget.itemWidth == null) {
      throw new Exception(
          "==============\n\nwidget.itemWith must not be null when use slider.\n========\n");
    }
  ...
  void _onController() {
    switch (widget.controller.event) {
      ...
      case IndexController.MOVE:
        throw new Exception(
            "Custom layout does not support SliderCarouselControllerEvent.MOVE_INDEX yet!");
...
class _CustomLayoutSliderCarousel extends _SubSliderCarousel {
...
class _CustomLayoutState extends _CustomLayoutStateBase<_CustomLayoutSliderCarousel> {
  ...
  @override
  void didUpdateWidget(_CustomLayoutSliderCarousel oldWidget) {
    _startIndex = widget.option.startIndex;
    _animationCount = widget.option.stateCount;
    super.didUpdateWidget(oldWidget);
  }
